package org.danielli.xultimate.netty.support;
...
public class ChannelInitializerFactoryBean implements FactoryBean<ChannelInitializer<SocketChannel>>, ApplicationContextAware {
	...
	public void setChannelHandlerAdapterBeanNameMap(
			Map<String, String> channelHandlerAdapterBeanNameMap) {
